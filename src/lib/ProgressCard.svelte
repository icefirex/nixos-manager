...
<style>
  ...
  .progress-percentage {
    ...
    line-height: 1;
    filter: drop-shadow(0 2px 4px rgba(var(--blue-rgb), 0.3));
  }
  ...
  .progress-bar-container {
    ...
    overflow: hidden;
    position: relative;
    box-shadow: inset 0 2px 4px rgba(var(--black-rgb), 0.2);
  }
  ...
  .progress-bar-text {
    ...
    font-weight: 600;
    color: var(--base);
    text-shadow: 0 1px 2px rgba(var(--white-rgb), 0.2);
  }
  ...
  .step-icon {
    ...
    font-size: 14px;
    font-weight: 600;
    background: rgba(var(--surface0-rgb), 0.95);
    border: 3px solid rgba(var(--surface0-rgb), 0.8);
  ...
  .step.active .step-icon {
    ...
    box-shadow: 0 0 24px rgba(var(--blue-rgb), 0.5);
  }

  @keyframes pulse {
    0%,
    100% {
      box-shadow: 0 0 0 0 rgba(var(--blue-rgb), 0.5),
        0 0 20px rgba(var(--blue-rgb), 0.3);
    }
    50% {
      box-shadow: 0 0 0 12px rgba(var(--blue-rgb), 0),
        0 0 30px rgba(var(--blue-rgb), 0.5);
    }
  }
